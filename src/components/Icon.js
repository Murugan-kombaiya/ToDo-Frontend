...
const Icon = ({ name, size = 20, color = 'currentColor', className = '', animated = false }) => {
  // SVG path definitions for custom icons
  const icons = {
    ...
    subtask: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4',
    calendar: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',
    clock: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z',
    timer: 'M12 8v4m0 0l3 3m-3-3l-3 3m9-3a9 9 0 11-18 0 9 9 0 0118 0z',
    deadline: 'M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
    
    // Status Icons
    todo: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
    inProgress: 'M12 2v6m0 0l3-3m-3 3l-3-3m3 15a9 9 0 110-18 9 9 0 010 18z',
    ...
    report: 'M9 17v1a1 1 0 001 1h4a1 1 0 001-1v-1m3-2V8a2 2 0 00-2-2H8a2 2 0 00-2 2v6h12zm-3-6V3a2 2 0 00-2-2h-4a2 2 0 00-2 2v2',
  ...
  const combinedClassName = `icon ${className} ${animationClass}`.trim();
